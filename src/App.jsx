...
//             <option value="BATASINGARAM">BATASINGARAM</option>
//             <option value="BOWRAMPET">BOWRAMPET</option>
//             <option value="CHILKUR">CHILKUR</option>
...
//             <option value="IBRAHIMPATAN / IBRAHIMPATNAM">
...
//             <option value="MASABTANK">MASABTANK</option>
...
//             <option value="YENKAPALLY">YENKAPALLY</option>
//           </select>
//         </label>
...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      const { phase, rank, gender, caste, place } = formData;
      const userRank = parseInt(rank);

      let matched = collegeData.filter((college) => {
        if (college.phase !== phase) return false;

        // If place filter is selected and non-empty, filter by place too
        if (place && college.place !== place) return false;
